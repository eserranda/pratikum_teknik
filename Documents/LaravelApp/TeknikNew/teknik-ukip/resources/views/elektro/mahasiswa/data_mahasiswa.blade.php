...
@section('content')
    <div class="card mb-6 mb-xl-9">
        <div class="card-header">
            <h3 class="card-title">Data Mahasiswa Teknik Elektro</h3>
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <form id="kt_modal_new_target_form" class="form">
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">Konsentrasi</label>
                            <select class="form-select form-select-solid" data-control="select2" data-hide-search="true"
                                data-placeholder="Pilih konsentrasi" name="konsentrasi" id="konsentrasi">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <form id="kt_modal_edit_target_form" class="form">
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            <label class="required fs-6 fw-semibold mb-2">Konsentrasi</label>
                            <select class="form-select form-select-solid" data-control="select2" data-hide-search="true"
                                data-placeholder="Pilih konsentrasi" name="edit_konsentrasi" id="edit_konsentrasi">
                                <option value="TTL">TTL</option>
                                <option value="TT">TT</option>
                                <option value="TN">TN</option>
                            </select>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                        ...
                        fetch(`/elektro/edit/${id}`)
                            ...
                            .then((data) => {
                                if (data) {
                                    ...
                                    document.getElementById("edit_konsentrasi").value = data
                                        .konsentrasi;
                ...
                editForm.addEventListener("submit", function(event) {
                    ...
                    const nama_mhs = document.getElementById("edit_nama_mhs").value;
                    const nim = document.getElementById("edit_nim").value;
                    const konsentrasi = document.getElementById("edit_konsentrasi").value;
                    const data = {
                        id: id,
                        nama_mhs: nama_mhs,
                        nim: nim,
                ...
                form.addEventListener('submit', function(event) {
                    ...
                    const nama_mhs = document.getElementById('nama_mhs').value;
