...
@section('content')
    <div class="card mb-6 mb-xl-9">
        <div class="card-header">
            <h3 class="card-title">Jadwal Praktikum Teknik Elektro</h3>
                    ...
                    <form id="kt_modal_new_target_form" class="form">
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                <span class="required">Kode MK</span>
                            </label>
                            <input type="text" class="form-control form-control-solid" name="kode_mk" id="kode_mk"
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                <span class="required">SKS</span>
                            </label>
                            <input type="text" class="form-control form-control-solid" name="sks" id="sks"
                                placeholder="SKS" />
                        </div>
                    ...
                    button.addEventListener("click", function(event) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                fetch(`/elektro/hapus_praktikum/${id}`, {
                                        method: "DELETE",
                                        headers: {
