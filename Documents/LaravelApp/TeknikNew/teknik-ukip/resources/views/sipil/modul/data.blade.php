...
@section('content')
    <div class="card mb-6 mb-xl-9">
        <div class="card-header">
            <h3 class="card-title">Download Modul Pratikum Teknik Sipil</h3>
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="modulForm" method="POST" action="/sipil/upload_endpoint" enctype="multipart/form-data">
                        <div class="mb-3">
        ...
        <script>
            ...
            downloadButtons.forEach(button => {
                button.addEventListener('click', function(e) {
                    ...
                    const downloadUrl = `/sipil/download/${id}`;
